/**
 * ========================================================================================
 * == SCRIPT DE AUTOMAÇÃO DE CLASSIFICAÇÃO DE O.S. (VERSÃO FINAL - TOTALMENTE DOCUMENTADO) ==
 * ========================================================================================
 *
 * Este script automatiza o processo de classificação de Ordens de Serviço (O.S.).
 * Suas principais características são:
 * - Permite ao usuário escolher a classificação a ser aplicada no início.
 * - Identifica O.S. não classificadas e que ainda não foram processadas na sessão.
 * - Abre um formulário, preenche com a opção escolhida e salva.
 * - Gerencia janelas pop-up para não sobrecarregar o computador, fechando-as
 * automaticamente em lotes de 5.
 * - Oferece um botão de controle manual para fechar as janelas a qualquer momento.
 * - É construído com pausas e esperas para lidar com o carregamento dinâmico da página.
 *
 */
